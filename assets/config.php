...
define('DB_USER', 'root');
define('DB_PASS', '');
define('DB_NAME', 'usertable'); //Nombre de la base de datos


// !configuracion de dsn para las diferentes bases de datos
$DNSproyectoir = "mysql:host=" . DB_HOST . ";dbname=" . DB_NAME;
// !creacion de instancias
// si tenemos un error en credimas bases de datos
try {
	$inicioRegistrodb = new PDO($DNSproyectoir, DB_USER, DB_PASS);
