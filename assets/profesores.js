...
function imprimirProfesores(ind, inicio, nroreg) {
  ...
  $.ajax({
    ...
    data.rta2.forEach(function (item) {
        ...
        htmlTags += '    <td>';
        htmlTags += '         <span onclick="leerprofesores(' + item.id + ');" style="cursor: pointer;">';
        ...
        htmlTags += '             </svg>';
        htmlTags += '         </span>';
        htmlTags += '         <span  onclick=" eliminarProfesor(' + item.id + ');" style="cursor: pointer;">';
    ...
    if (inicio > 1) {
        paginador += '<li><a style="font-size: 13px; font-weight: bolder; color: #1346c9; background-color: white; border-radius: 5px; border: solid 1px #C0C0C0; padding: 8px 10px; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.2);" href="javascript:void(0)" onclick="imprimirProfesores(\'2\', 1, ' + nroreg + ', \'\', \'\', \'\', \'\', \'\', \'\')">&laquo;</a></li>';
        paginador += '<li><a style="font-size: 13px; font-weight: bolder; color: #1346c9; background-color: white; border-radius: 5px; border: solid 1px #C0C0C0; padding: 8px 10px; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.2);" href="javascript:void(0)" onclick="imprimirProfesores(\'2\', ' + (inicio - 1) + ', ' + nroreg + ', \'\', \'\', \'\', \'\', \'\', \'\')">&lsaquo;</a></li>';
    ...
    for (let i = limit1; i <= limit2; i++) {
        if (i === inicio) {
            ...
            paginador += '<li><a style="font-size: 13px; font-weight: bold; color: #1346c9; background-color: #FFFFFF; border: solid 1px #C0C0C0; padding: 8px 10px; border-radius: 5px; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.2);" href="javascript:void(0)" onclick="imprimirProfesores(\'2\', ' + i + ', ' + nroreg + ', \'\', \'\', \'\', \'\', \'\', \'\')">' + i + '</a></li>';
        }

    }
    if (inicio < Math.ceil(data.rta / parseInt(nroreg))) {
        paginador += '<li><a style="font-size: 13px; font-weight: bolder; color: #1346c9; background-color: white; border-radius: 5px; border: solid 1px #C0C0C0; padding: 8px 10px; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.2);" href="javascript:void(0)" onclick="imprimirProfesores(\'2\', ' + (inicio + 1) + ', ' + nroreg + ',\'\',\'\',\'\',\'\',\'\',\'\')">&rsaquo;</a></li>';
        paginador += '<li><a style="font-size: 13px; font-weight: bolder; color: #1346c9; background-color: white; border-radius: 5px; border: solid 1px #C0C0C0; padding: 8px 10px; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.2);" href="javascript:void(0)" onclick="imprimirProfesores(\'2\', ' + Math.ceil(data.rta / nroreg) + ', ' + nroreg + ', \'\',\'\',\'\',\'\',\'\',\'\')">&raquo;</a></li>';
    } else {
